...
# ![](toi_103_files/flux_vs_time.png)
...
#
# ![](toi_103_files/diagnostic_raw_lc_plot.png)
# ![](toi_103_files/diagnostic_raw_lc_plot_zoom.png)
# -
...
if tic_entry.optimized_params is None:
    ...
    init_params = get_optimized_init_params(
        planet_transit_model, **params, quick=True
    )
...
# SHOW LC PLOT WITH INITIAL MODEL
# ![](toi_103_files/lightcurve_with_initial_guess.png)

# + [markdown] tags=["hide-cell"]
# ![](toi_103_files/lightcurve_with_initial_guess_zoom.png)
...
# SHOW PHASE PLOT
# <img src="toi_103_files/phase_initial.png" style="width:450px;"/>
# <img src="toi_103_files/phase_initial_all_datapoints.png" style="width:450px;"/>
